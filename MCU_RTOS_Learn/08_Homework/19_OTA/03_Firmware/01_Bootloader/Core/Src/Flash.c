 ...
 * @brief  擦除 APP 区域的数据
 * 
 * @param [in]  FLASH_Sector 
 * @return      
 * 
 * @details     F4 是按照扇区操作，计划将APP放在扇区6 FLASH_Sector_6, 备份 APP 放在 扇区7 
 * @note
 * @warning
 */
...
{
    FlashUnlock();
    FLASH_Status flash_status = FLASH_EraseSector(FLASH_Sector, VoltageRange_3); // 什么含义？
