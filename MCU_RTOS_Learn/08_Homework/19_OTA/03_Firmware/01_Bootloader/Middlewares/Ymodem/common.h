...
// #define BackAppAddress     0x0803D000   //���ص��������洢λ��

// #define ApplicationAddress 0x08003000   //���е�APP�洢λ��
...
#define FLASH_IMAGE_SIZE                   (uint32_t) (FLASH_SIZE - (APPLICATION_ADDRESS - 0x08000000))
